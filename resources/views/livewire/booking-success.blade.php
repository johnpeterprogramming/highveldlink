@php
    $preferredArrivalTime = $booking->departureTime()->subMinutes(20);
@endphp
<div class="py-8">
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div class="p-6 space-y-6">
                <div class="rounded-lg p-6 space-y-3">
                    <h3 class="text-lg font-semibold text-gray-900 mb-4">Your booking from
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-100">
                                <tr>
                                    <td class="px-4 py-2 text-gray-900">{{ $booking->departureTime() }}</td>
                    ...
                    <div class="mt-8 flex items-center space-x-2">
                        <p class="text-gray-700">
                            ...
                            (<span class="text-blue-700">{{ $preferredArrivalTime }}</span>).
                        </p>
                    </div>
                </div>
